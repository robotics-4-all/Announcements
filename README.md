...
Περιεχόμενα:
- [R4A-Spring20-1: End-to-end μεθοδολογία ανάπτυξης εφαρμογών για απομακρυσμένα κυβερνοφυσικά συστήματα](1)
- R4A-Spring20-2: Έλεγχος ανθρωπόμορφου ρομπότ με χρήση φυσικής γλώσσας, chatbots και μετασχηματισμών μοντέλων σε κώδικα
- R4A-Spring20-3: Εκτίμηση χρόνου αποφόρτισης μπαταρίας με χρήση τεχνικών μηχανικής μάθησης
- R4A-Spring20-4: Ενορχήστρωση εφαρμογών και συμπεριφορών σε Edge συστήματα
- R4A-Spring20-3: Υποστήριξη συνεργατικής δημιουργίας εφαρμογών και διαμοιρασμού τους, με χρήση του εργαλείου NodeRed και υποδομών νέφους
